...
if ($action == 'generateExtrafields') {
	...
	$ret4 = $extra_fields->addExtraField('digiriskdolibarr_ticket_service', $langs->transnoentities("Service"), 'varchar', 2300, 255, 'ticket', 0, 0, '', '', 1, '', 4, '', '', 0);
...
if ($action == 'generateQRCode') {
	...
	$QR = imagecreatefrompng('https://chart.googleapis.com/chart?cht=qr&chld=H|1&chs='.$qrcode_size.'&chl='.urlencode($data));
