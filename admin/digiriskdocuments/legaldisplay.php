...
$title    = $langs->trans("YourDocuments"). ' - '. $langs->trans("LegalDisplay");
...
print dol_get_fiche_head($head, 'legaldisplay', '', -1, "digiriskdolibarr@digiriskdolibarr");
