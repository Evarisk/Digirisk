...
/**
 * \file    admin/listingrisksphoto.php
 * \ingroup digiriskdolibarr
 * \brief   Digiriskdolibarr listingrisksphoto page.
 */
...
if ($action == 'updateMask') {
	...
	$masklistingrisksphoto      = GETPOST('masklistingrisksphoto', 'alpha');

	if ($maskconstlistingrisksphoto) $res = dolibarr_set_const($db, $maskconstlistingrisksphoto, $masklistingrisksphoto, 'chaine', 0, '', $conf->entity);
...
$title    = $langs->trans("YourDocuments"). ' - '. $langs->trans("ListingRisksPhoto");
...
print dol_get_fiche_head($head, 'listingrisksphoto', '', -1, "digiriskdolibarr@digiriskdolibarr");
...
/*
*  Documents models for Listing Risks Photo
*/
