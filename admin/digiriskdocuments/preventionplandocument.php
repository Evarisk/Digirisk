...
if ($action == 'updateMask') {
	...
	if ($maskconstpreventionplandocument) $res = dolibarr_set_const($db, $maskconstpreventionplandocument, $maskpreventionplandocument, 'chaine', 0, '', $conf->entity);
...
if ($action == 'set') {
	...
	} elseif ( $value == 'preventionplandocument_custom_odt' ) {
...
$title    = $langs->trans("YourDocuments"). ' - '. $langs->trans("PreventionPlanDocument");
...
print load_fiche_titre($langs->trans("DigiriskPreventionPlanDocumentNumberingModule"), '', '');
