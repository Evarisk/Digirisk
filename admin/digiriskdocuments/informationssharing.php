...
/**
 * \file    digiriskdolibarr/admin/informationssharing.php
 * \ingroup digiriskdolibarr
 * \brief   Digiriskdolibarr informationssharing page.
 */
...
elseif ($action == 'set')
{
	...
	if ( $value == 'informationssharing_odt' ) {
		$description = "DIGIRISKDOLIBARR_".strtoupper($type)."_ADDON_ODT_PATH";
	} elseif ( $value == 'informationssharing_custom_odt' ) {
...
$help_url  = 'FR:Module_DigiriskDolibarr#L.27onglet_Diffusion_d.27informations';
