...
/**
 * \file    admin/informationssharing.php
...
$title    = $langs->trans("YourDocuments"). ' - '. $langs->trans("InformationsSharing");
...
print dol_get_fiche_head($head, 'informationssharing', '', -1, "digiriskdolibarr@digiriskdolibarr");
