...
/**
 * \file    admin/firepermitdet.php
 * \ingroup digiriskdolibarr
 * \brief   Digiriskdolibarr firepermitdet page.
 */
...
if ($action == 'updateMask') {
	$maskconstfirepermitdet = GETPOST('maskconstfirepermitdet', 'alpha');
	$maskfirepermitdet      = GETPOST('maskfirepermitdet', 'alpha');

	if ($maskconstfirepermitdet) $res = dolibarr_set_const($db, $maskconstfirepermitdet, $maskfirepermitdet, 'chaine', 0, '', $conf->entity);
...
$title    = $langs->trans("DigiriskElement") . ' - ' . $langs->trans("FirePermitDet");
...
print dol_get_fiche_head($head, 'firepermitdet', '', -1, "digiriskdolibarr@digiriskdolibarr");
