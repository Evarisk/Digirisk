...
/**
 * \file    admin/preventionplandet.php
...
$title    = $langs->trans("DigiriskElement") . ' - ' . $langs->trans("PreventionPlanDet");
...
print dol_get_fiche_head($head, 'preventionplandet', '', -1, "digiriskdolibarr@digiriskdolibarr");
