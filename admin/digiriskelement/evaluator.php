...
$title    = $langs->trans("DigiriskElement") . ' - ' . $langs->trans("Evaluator");
...
print dol_get_fiche_head($head, 'evaluator', '', -1, "digiriskdolibarr@digiriskdolibarr");
