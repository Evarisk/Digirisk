async function loadCategoryMap(){let e={};return window.digiriskdolibarr.categoryMap[0].risk.forEach(i=>{e[i.thumbnail_name]=i.name}),window.digiriskdolibarr.categoryMap[0].riskenvironmental.forEach(i=>{e[i.thumbnail_name]=i.name}),console.log(e),e}window.digiriskdolibarr||(window.digiriskdolibarr={},window.digiriskdolibarr.scriptsLoaded=!1),window.digiriskdolibarr.scriptsLoaded||(window.digiriskdolibarr.init=function(){window.digiriskdolibarr.load_list_script()},window.digiriskdolibarr.load_list_script=function(){if(!window.digiriskdolibarr.scriptsLoaded){var i=void 0,e=void 0;for(i in window.digiriskdolibarr)for(e in window.digiriskdolibarr[i].init&&window.digiriskdolibarr[i].init(),window.digiriskdolibarr[i])window.digiriskdolibarr[i]&&window.digiriskdolibarr[i][e]&&window.digiriskdolibarr[i][e].init&&window.digiriskdolibarr[i][e].init();window.digiriskdolibarr.scriptsLoaded=!0}},window.digiriskdolibarr.refresh=function(){var i=void 0,e=void 0;for(i in window.digiriskdolibarr)for(e in window.digiriskdolibarr[i].refresh&&window.digiriskdolibarr[i].refresh(),window.digiriskdolibarr[i])window.digiriskdolibarr[i]&&window.digiriskdolibarr[i][e]&&window.digiriskdolibarr[i][e].refresh&&window.digiriskdolibarr[i][e].refresh()},$(document).ready(window.digiriskdolibarr.init)),window.digiriskdolibarr.accident={},window.digiriskdolibarr.accident.init=function(){window.digiriskdolibarr.accident.event()},window.digiriskdolibarr.accident.event=function(){$(document).on("submit",".sendfile",window.digiriskdolibarr.accident.tmpStockFile),$(document).on("click",".linked-file-delete-workstop",window.digiriskdolibarr.accident.removeFile),$(document).on("change","#external_accident",window.digiriskdolibarr.accident.showExternalAccidentLocation)},window.digiriskdolibarr.accident.tmpStockFile=function(e,i=""){var s=$("#sendfile").prop("files"),t=new FormData;for(let i=0;i<s.length;i++){var a=s[i];t.append("files[]",a)}var n=window.saturne.toolbox.getToken(),i=0<i.length?"&subaction="+i:"";$.ajax({url:document.URL+"&action=sendfile&objectlineid="+e+"&token="+n+i,type:"POST",processData:!1,contentType:!1,data:t,success:function(i){$("#sendFileForm"+e).html($(i).find("#fileLinkedTable"+e))},error:function(){}})},window.digiriskdolibarr.accident.removeFile=function(i){let e=$(this).attr("value");var s=$(this).hasClass("edit-line")?"&subaction=editline":"";e=e.replace("_mini","");let t=$(this).closest(".objectline").attr("value");var a=window.saturne.toolbox.getToken();$.ajax({url:document.URL+"&action=removefile&filetodelete="+e+"&objectlineid="+t+"&token="+a+s,type:"POST",processData:!1,contentType:!1,success:function(i){$("#sendFileForm"+t).html($(i).find("#fileLinkedTable"+t))},error:function(){}})},window.digiriskdolibarr.accident.showExternalAccidentLocation=function(){var i=$(this).closest(".accident-table").find(".fk_element_field"),e=$(this).closest(".accident-table").find(".fk_soc_field"),s=$(this).closest(".accident-table").find(".accident_location_field");switch($(this).closest(".accident-table").find("#select2-external_accident-container").attr("title")){case"Non":i.attr("style",""),e.attr("style","display:none"),s.attr("style","display:none"),i.removeClass("hidden"),e.addClass("hidden"),s.addClass("hidden");break;case"Oui":i.attr("style","display:none"),e.attr("style",""),s.attr("style","display:none"),i.addClass("hidden"),e.removeClass("hidden"),s.addClass("hidden");break;case"Autre":i.attr("style","display:none"),e.attr("style","display:none"),s.attr("style",""),i.addClass("hidden"),e.addClass("hidden"),s.removeClass("hidden")}},window.digiriskdolibarr.admin={},window.digiriskdolibarr.admin.urlSuffix="-ticket-public-interface-url",window.digiriskdolibarr.admin.optionKeys=["origin-current","short-current","external-current","origin-multicompany","short-multicompany","external-multicompany"],window.digiriskdolibarr.admin.mappings=window.digiriskdolibarr.admin.optionKeys.map(i=>({radio:"#"+i+window.digiriskdolibarr.admin.urlSuffix,label:`#${i}${window.digiriskdolibarr.admin.urlSuffix}-label`,input:`#${i}${window.digiriskdolibarr.admin.urlSuffix}-input`})),window.digiriskdolibarr.admin.init=function(){window.digiriskdolibarr.admin.initRadioLogicTicketPublicInterface()},window.digiriskdolibarr.admin.initRadioLogicTicketPublicInterface=function(){window.digiriskdolibarr.admin.mappings.forEach(({radio:i,label:e,input:s})=>{$(document).on("click",e,()=>{$(i).prop("checked",!0),s&&$(s).focus()}),s&&$(document).on("focus",s,()=>{$(i).prop("checked",!0)})})},window.digiriskdolibarr.digiai={},window.digiriskdolibarr.digiai.init=function(){window.digiriskdolibarr.digiai.event()},window.digiriskdolibarr.digiai.event=function(){$(document).on("change","#image_file",window.digiriskdolibarr.digiai.submitForm)},window.digiriskdolibarr.digiai.submitForm=async function(i){i.preventDefault(),window.digiriskdolibarr.digiai.resetModal();let m=window.saturne.toolbox.getToken(),v=$("#dol_url_root").val();var i=document.getElementById("image_file"),e=i.files[0];if(e){let k=$("#digiriskElementId").val(),u=await loadCategoryMap();i.value="";i=URL.createObjectURL(e);$("#uploaded-image-preview").attr("src",i).css("opacity",1),$(".analysis-in-progress").show().css("opacity",1),$(".analysis-result").hide(),$("#digiai_modal").addClass("modal-active");try{var s=new FormData,t=(s.append("image_file",e),await fetch("backend_endpoint_for_chatgpt.php?token="+m,{method:"POST",body:s}));if(!t.ok)throw new Error("Failed to fetch ChatGPT with image");var a=(await t.json()).choices[0].message.content.trim().replace(/^```json\s*|```$/g,"").trim(),n=JSON.parse(a),r=($(".modal-analyse-phase").fadeOut(400,function(){$(".modal-result-phase").fadeIn(400)}),$("#risque_table"));r.css("display","table");let c=r.find("tbody");c.empty(),n.forEach((i,e)=>{var e=$('<tr class="oddeven" id="new_risk'+e+'">'),s=i.title,t=(e.attr("data-category",s),parseInt(i.cotation)),a=i.description,i=i.prevention_actions,a=$("<textarea>").addClass("form-control").val(a).css({width:"100%",height:"60px"});let n=t<=47?1:t<=50?2:t<=80?3:4;let r=$(`
      ...
      `),o=r.find(".cotation-listing"),d=$('<input type="hidden" name="cotation[]" value="'+t+'">'),l=(r.append(d),Object.entries({1:{value:0,label:"0-47"},2:{value:48,label:"48-50"},3:{value:51,label:"51-80"},4:{value:100,label:"81-100"}}).forEach(([i,e])=>{e=$(`
          ...
          `);e.css("cursor","pointer"),parseInt(i)===n&&e.addClass("selected-cotation"),e.on("click",function(){o.find(".selected-cotation").removeClass("selected-cotation"),$(this).addClass("selected-cotation"),d.val($(this).data("evaluation-id"))}),o.append(e)}),$("<div>"));i.forEach(i=>{i=$("<textarea>").addClass("form-control action-textarea").val(i).css({width:"100%",height:"32px",resize:"vertical",overflow:"hidden",lineHeight:"1.4",padding:"6px 8px",fontSize:"13px"});l.append(i)});t=$("<img>").addClass("danger-category-pic tooltip wpeo-tooltip-event hover").attr("src",v+"/custom/digiriskdolibarr/img/categorieDangers/"+s+".png").attr("aria-label",u[s]||"Catégorie inconnue"),i=$('<input type="checkbox" class="select-risk">');i.on("change",function(){var i=0<$(".select-risk:checked").length;$("#submit_selected_risks").prop("disabled",!i),$("#submit_selected_risks").css("opacity",i?1:.6)}),e.append($("<td>").append(i)),e.append($("<td>").append(t)),e.append($("<td>").append(r)),e.append($("<td>").append(a)),e.append($("<td>").append(l)),$("#submit_selected_risks").off("click").on("click",function(){$("input.select-risk:checked").closest("tr").each(function(){let e=$(this);var i=e.find("textarea").val(),s=parseInt(e.find('input[name="cotation[]"]').val());let t=[];e.find("textarea.action-textarea").each(function(){var i=$(this).val().trim();""!==i&&t.push(i)});var a=e.data("category");$.ajax({url:v+"/custom/digiriskdolibarr/core/ajax/create_risk.php?token="+m,method:"POST",data:JSON.stringify({description:i,cotation:s,method:"simple",fk_element:k,category:a,photo:"",tasks:t,dateStart:"",hourStart:"",minStart:"",dateEnd:"",hourEnd:"",minEnd:"",budget:""}),contentType:"application/json",dataType:"json",cache:!1,headers:{"X-Requested-With":"XMLHttpRequest"},success:function(){var i=e.clone();i.find(".select-risk").remove(),i.find('textarea, input[type="text"], input[type="number"]').prop("disabled",!0),i.find(".risk-evaluation-cotation").each(function(){$(this).hasClass("selected-cotation")||$(this).hide()}),$(".risque-table .previous-risks-list").append(i),e.remove(),$("#submit_selected_risks").prop("disabled",!0).css("opacity",.6),window.saturne.loader.remove($("#submit_selected_risks")),$("#submit_selected_risks").removeClass("button-disable")},error:function(i,e,s){alert("Erreur lors de l'ajout d'un risque : "+(i.responseText||s))}})})}),r.find(".risk-evaluation-cotation").on("click",function(){r.find(".selected-cotation").removeClass("selected-cotation"),$(this).addClass("selected-cotation"),d.val($(this).data("evaluation-id"))}),c.append(e)})}catch(i){$(".analysis-in-progress").empty().append("Une erreur est survenue : "+i.message)}}else alert("Veuillez sélectionner une image.")},window.digiriskdolibarr.digiai.resetModal=function(){$("#digiai_modal").addClass("modal-active"),$(".modal-analyse-phase").show(),$(".modal-result-phase").hide(),$("#uploaded-image-preview").attr("src","").show(),$(".analysis-in-progress").show().html(`
