...
/**
 *   	\file       informationssharing_list.php
 *		\ingroup    digiriskdolibarr
 *		\brief      List page for informationssharing
 */
...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'informationssharinglist'; // To manage different context of search
...
$hookmanager->initHooks(array('informationssharinglist')); // Note that conf->hooks_modules contains array
...
if (empty($reshook))
{
	...
	// Mass actions
	$objectclass = 'InformationsSharing';
	$objectlabel = 'InformationsSharing';
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page)
{
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/digiriskdolibarr/informationssharing_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/digiriskdolibarr/informationssharing_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendInformationsSharingRef";
$modelmail = "informationssharing";
$objecttmp = new InformationsSharing($db);
