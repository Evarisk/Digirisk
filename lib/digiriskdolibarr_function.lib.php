...
$return .= '<div><div class="wpeo-button button-square-50 button-blue">
							<i class="fas fa-star button-icon"></i>
						</div>
						<div class="wpeo-button button-square-50 button-grey media-gallery-unlink media-gallery-unlink" value="'.$object->id .'">
