...
function digiriskdolibarr_admin_prepare_head(): array
{
    ...
    $head[$h][0] = dol_buildpath('/saturne/admin/pwa.php', 1). '?module_name=DigiriskDolibarr&start_url=' . dol_buildpath('/custom/digiriskdolibarr/public/create_ticket.php', 3);
