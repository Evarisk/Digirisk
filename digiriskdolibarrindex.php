...
/**
 *	\file       digiriskdolibarr/digiriskdolibarrindex.php
...
// Security check
//if (! $user->rights->digiriskdolibarr->myobject->read) accessforbidden();
...
// Draft MyObject
if (! empty($conf->digiriskdolibarr->enabled) && $user->rights->digiriskdolibarr->read)
{
	$langs->load("orders");
