...
/**
 *	\file       htdocs/informationsrelease/class/informationsrelease_ik.class.php
 *	\ingroup    expenseik
 ...
 */
class InformationsReleaseRule extends CoreObject
{
	/**
	 ...
	 */
	public $table_element = 'informationsrelease_rules';
	 ...
	 * @return array                        Array with InformationsReleaseRule
	 */
	public static function getAllRule($fk_c_type_fees = '', $date = '', $fk_user = '')
	{
		...
		$rules = array();
		$sql = 'SELECT er.rowid';
		$sql .= ' FROM '.MAIN_DB_PREFIX.'informationsrelease_rules er';
		...
		dol_syslog("InformationsReleaseRule::getAllRule sql=".$sql);
		...
		if ($resql)
		{
			...
			{
				$rule = new InformationsReleaseRule($db);
