...
class Groupment extends DigiriskElement
{
	 ...
	 */
	//public $table_element_line = 'digiriskdolibarr_groupmentline';

	/**
	 * @var int    Field with ID of parent key if this object has a parent
	 */
	//public $fk_element = 'fk_groupment';
	 ...
	 */
	//protected $childtablesoncascade = array('digiriskdolibarr_groupmentdet');
	...
	public function __construct(DoliDB $db)
	{
		...
		/*if ($user->rights->digiriskdolibarr->groupment->read) {
