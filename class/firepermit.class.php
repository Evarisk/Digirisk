 ...
 */
class FirePermit extends DigiriskDocuments
{
	...
	/**
	 * @var string String with name of icon for firepermit. Must be the part after the 'object_' into object_firepermit.png
	 */
	public $picto = 'firepermit@digiriskdolibarr';
	 ...
	 */
	//public $table_element_line = 'digiriskdolibarr_firepermitline';

	/**
	 * @var int    Field with ID of parent key if this object has a parent
	 */
	//public $fk_element = 'fk_firepermit';

	/**
	 * @var int    Name of subtable class that manage subtable lines
	 */
	//public $class_element_line = 'FirePermitline';
	 ...
	 */
	//protected $childtablesoncascade = array('digiriskdolibarr_firepermitdet');
...
//		}
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$url = dol_buildpath('/digiriskdolibarr/firepermit_card.php', 1).'?id='.$this->id;
		...
		if (empty($notooltip))
		{
			...
			{
				$label = $langs->trans("ShowFirePermit");
		...
		$hookmanager->initHooks(array('firepermitdao'));
...
/**
 * Class FirePermitLine. You can also remove this and generate a CRUD class for lines objects.
 */
class FirePermitLine
{
	// To complete with content of an object FirePermitLine
	// We should have a field rowid, fk_firepermit and position
