...
class GroupmentDocument extends DigiriskDocuments
{
	...
	/**
	 * @var string String with name of icon for groupmentdocument. Must be the part after the 'object_' into object_groupmentdocument.png
	 */
	public $picto = 'groupmentdocument@digiriskdolibarr';
