...
/**
 * \file        class/listingrisksaction.class.php
 * \ingroup     digiriskdolibarr
 * \brief       This file is a CRUD class file for Groupment(Create/Read/Update/Delete)
 */
 ...
 * Class for Groupment
 */
class ListingRisksAction extends DigiriskElement
{
	...
	/**
	 * @var string String with name of icon for listingrisksaction. Must be the part after the 'object_' into object_listingrisksaction.png
	 */
	public $picto = 'listingrisksaction@digiriskdolibarr';
	 ...
	 */
	//public $table_element_line = 'digiriskdolibarr_listingrisksactionline';

	/**
	 * @var int    Field with ID of parent key if this object has a parent
	 */
	//public $fk_element = 'fk_listingrisksaction';
	 ...
	 */
	//protected $childtablesoncascade = array('digiriskdolibarr_listingrisksactiondet');
	...
	public function generateDocument($modele, $outputlangs, $hidedetails = 0, $hidedesc = 0, $hideref = 0, $moreparams = null)
	{
		...
		$path = DOL_DOCUMENT_ROOT . '/custom/digiriskdolibarr/documents/doctemplates/';
