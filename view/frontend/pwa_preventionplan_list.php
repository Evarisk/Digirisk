...
/**
 * \file    view/frontend/pwa_preventionplan_list.php
 * \ingroup digiriskdolibarr
 * \brief   PWA screen listing the prevention plans (search, status filter, pagination).
 */
...
// Security check
$permissiontoread = $user->hasRight('digiriskdolibarr', 'preventionplan', 'read');
...
$listStatusOptions = [
    ...
    PreventionPlan::STATUS_DRAFT       => $langs->transnoentities('InProgress'),
    PreventionPlan::STATUS_VALIDATED   => $langs->transnoentities('ValidatePendingSignature'),
    PreventionPlan::STATUS_LOCKED      => $langs->transnoentities('Locked'),
    PreventionPlan::STATUS_ARCHIVED    => $langs->transnoentities('Archived'),
];
...
$title = $langs->trans('PwaNavPreventionPlans');
