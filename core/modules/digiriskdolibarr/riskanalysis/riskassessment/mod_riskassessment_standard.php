...
class mod_riskassessment_standard extends ModeleNumRefRiskAnalysis
{
	...
	public function info()
	{
		...
		return $langs->trans('DigiriskRiskAssessmentStandardModel', $this->prefix);
	}
	...
	public function getNextValue($object, $version = 0)
	{
		...
		$sql .= " FROM ".MAIN_DB_PREFIX."digiriskdolibarr_riskassessment";
		...
		dol_syslog("mod_riskassessment_standard::getNextValue return ".$this->prefix.$num);
