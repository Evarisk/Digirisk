...
class mod_informationssharing_standard extends ModeleNumRefInformationsSharing
{
	...
	public function __construct()
	{
		...
		$this->prefixinformationssharing =  $nowDate . '_' .$this->prefixinformationssharing;
	}
	...
	public function info()
	{
		...
		return $langs->trans('DigiriskInformationsSharingStandardModel', $this->prefixinformationssharing);
	}
