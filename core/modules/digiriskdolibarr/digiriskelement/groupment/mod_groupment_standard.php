...
/**
 *	\file       core/modules/digiriskdolibarr/digiriskelement/groupment/mod_groupment_standard.php
 * \ingroup     digiriskdolibarr
 *	\brief      File containing class for groupment numbering module Standard
 */
...
class mod_groupment_standard extends ModeleNumRefDigiriskElement
{
	...
	public function info()
	{
		...
		return $langs->trans('DigiriskGroupmentStandardModel', $this->prefix);
	}
	...
	public function getNextValue($object)
	{
		...
		dol_syslog("mod_groupment_standard::getNextValue return " . $this->prefix . $num);
	...
	public function getLastValue($object)
	{
		...
		if ($resql) {
			...
			dol_syslog("mod_groupment_standard::getlastValue", LOG_DEBUG);
			return -1;
		}
