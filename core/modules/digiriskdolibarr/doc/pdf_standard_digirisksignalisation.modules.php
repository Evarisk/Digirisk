...
/**
 *  \file       core/modules/digiriskdolibarr/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_digirisksignalisation
 */
class pdf_standard_digirisksignalisation extends ModelePDFDigiriskSignalisation
{
    /**
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
	    ...
	    /*
	    if (!empty($conf->global->MAIN_GENERATE_DIGIRISKSIGNALISATION_WITH_PICTURE))
	    {
		...
		*/
	    ...
	    if ($conf->digiriskdolibarr->dir_output.'/digirisksignalisation')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->digiriskdolibarr->dir_output.'/digirisksignalisation';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->digiriskdolibarr->dir_output.'/digirisksignalisation/'.$objectref;
