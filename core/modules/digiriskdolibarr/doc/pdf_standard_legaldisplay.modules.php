...
/**
 *	Class to manage PDF template standard_legaldisplay
 */
class pdf_standard_legaldisplay extends ModelePDFLegalDisplay
{
    /**
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
	    ...
	    if ($conf->digiriskdolibarr->dir_output.'/legaldisplay')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->digiriskdolibarr->dir_output.'/legaldisplay';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->digiriskdolibarr->dir_output.'/legaldisplay/'.$objectref;
