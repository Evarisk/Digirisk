...
dol_include_once('/digiriskdolibarr/core/modules/digiriskdolibarr/modules_preventionplan.php');
...
/**
 *	Class to manage PDF template standard_preventionplan
 */
class pdf_standard_preventionplan extends ModelePDFPreventionPlan
{
    /**
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
	    ...
	    /*
	    if (!empty($conf->global->MAIN_GENERATE_LEGALDISPLAY_WITH_PICTURE))
	    {
		...
		*/
	    ...
	    if ($conf->digiriskdolibarr->dir_output.'/preventionplan')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->digiriskdolibarr->dir_output.'/preventionplan';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->digiriskdolibarr->dir_output.'/preventionplan/'.$objectref;
