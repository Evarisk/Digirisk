...
/**
 *	Class to manage PDF template standard_informationssharing
 */
class pdf_standard_informationssharing extends ModelePDFInformationsSharing
{
    /**
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
	    ...
	    /*
	    if (!empty($conf->global->MAIN_GENERATE_INFORMATIONSSHARING_WITH_PICTURE))
	    {
		...
		*/
	    ...
	    if ($conf->digiriskdolibarr->dir_output.'/informationssharing')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->digiriskdolibarr->dir_output.'/informationssharing';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->digiriskdolibarr->dir_output.'/informationssharing/'.$objectref;
