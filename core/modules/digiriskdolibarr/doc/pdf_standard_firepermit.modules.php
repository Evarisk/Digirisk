...
dol_include_once('/digiriskdolibarr/core/modules/digiriskdolibarr/modules_firepermit.php');
...
/**
 *	Class to manage PDF template standard_firepermit
 */
class pdf_standard_firepermit extends ModelePDFFirePermit
{
    /**
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
	    ...
	    /*
	    if (!empty($conf->global->MAIN_GENERATE_FIREPERMIT_WITH_PICTURE))
	    {
		...
		*/
	    ...
	    if ($conf->digiriskdolibarr->dir_output.'/firepermit')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->digiriskdolibarr->dir_output.'/firepermit';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->digiriskdolibarr->dir_output.'/firepermit/'.$objectref;
