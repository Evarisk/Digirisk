...
/**
 *	\file       core/modules/digiriskdolibarr/digiriskdocuments/preventionplandocument/doc_preventionplandocument_specimen_odt.modules.php
	...
	public function info($langs)
	{
		...
		if ($nbofiles) {
			...
			foreach ($listoffiles as $file) {
				$texte .= '- '.$file['name'].' &nbsp; <a class="reposition" href="'.DOL_URL_ROOT . '/custom/digiriskdolibarr/documents/doctemplates/preventionplandocument/specimen/'.urlencode(basename($file['name'])).'?">'.img_picto('', 'listlight').'</a>';
				$texte .= '<br>';
			}
			$texte .= '</div>';
