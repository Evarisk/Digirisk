...
/**
 *  \file    core/modules/digiriskdolibarr/address/mod_accident_investigation_document_standard.php
 ...
 */
class mod_accident_investigation_document_standard extends ModeleNumRefSaturne
{
	/**
