...
/**
 *	\file       core/modules/digiriskdolibarr/digiriskdocuments/legaldisplay/mod_legaldisplay_standard.php
 ...
 */
class mod_legaldisplay_standard extends ModeleNumRefDigiriskDocuments
{
	/**
	...
	public function getNextValue($object)
	{
		...
		dol_syslog("mod_legaldisplay_standard::getNextValue return " . $this->prefix . $num);
