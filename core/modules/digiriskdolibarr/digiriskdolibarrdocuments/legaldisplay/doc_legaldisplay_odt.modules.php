...
class doc_legaldisplay_odt extends ModeleODTLegalDisplay
{
	...
	public function write_file(SaturneDocuments $objectDocument, Translate $outputLangs, string $srcTemplatePath, int $hideDetails = 0, int $hideDesc = 0, int $hideRef = 0, array $moreParam): int
	{
		...
		$numberingModules = [
			'digiriskdolibarrdocuments/legaldisplay' => $conf->global->DIGIRISKDOLIBARR_LEGALDISPLAY_ADDON
		];
		...
		$dir                                             = $conf->digiriskdolibarr->multidir_output[isset($objectDocument->entity) ? $objectDocument->entity : 1] . '/legaldisplay';
