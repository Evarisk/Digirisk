 ...
 */
class mod_informationssharing_gridr extends CustomModeleNumRefSaturne
{
    /**
     * @var string Model name
     */
    public string $name = 'Gridr';

    public function __construct()
    {
        global $conf;

        $refMod = $conf->global->DIGIRISKDOLIBARR_INFORMATIONSSHARING_GRIDR_ADDON;
