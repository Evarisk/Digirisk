...
/**
 * \file    core/modules/digiriskdolibarr/digiriskdolibarrdocuments/workunitdocument/doc_workunitdocumentinherited_odt.modules.php
 * \ingroup digiriskdolibarr
 * \brief   File of class to build ODT workunit document listing inherited (and children) risks
 */
 ...
 *
 * Generation logic is shared with the "shared risks" sheet (doc_workunitdocumentshared_odt): both compute the
 ...
 */
class doc_workunitdocumentinherited_odt extends ModeleODTDigiriskDolibarrDocument
{
    /**
     * @var string Document type
     *
     * Kept identical to the standard workunit document so numbering, storage directory and the card
