...
/**
 * \file    core/modules/digiriskdolibarr/digiriskdolibarrdocuments/groupmentdocument/doc_groupmentdocumentinherited_odt.modules.php
 * \ingroup digiriskdolibarr
 * \brief   File of class to build ODT groupment document listing inherited (and children) risks
 */
 ...
 *
 * Generation logic is shared with the "shared risks" sheet (doc_groupmentdocumentshared_odt): both compute the
 * inherited/children and shared risk tables. The category actually rendered depends only on the ODT template,
 * which contains a single segment set (inheritedRisks1..4 here, sharedRisks1..4 for the shared sheet).
 */
class doc_groupmentdocumentinherited_odt extends ModeleODTDigiriskDolibarrDocument
{
    /**
     * @var string Document type
     *
     * Kept identical to the standard groupment document so numbering, storage directory and the card
     * file listing are reused. The dedicated ODT template is resolved from the document model row
     * description (the *_ADDON_ODT_PATH constant), not from this property.
     */
    ...
    public function fillTagsLines(Odf $odfHandler, Translate $outputLangs, array $moreParam): int
    {
        ...
        $moreParam['includeInheritedAndShared'] = true;
