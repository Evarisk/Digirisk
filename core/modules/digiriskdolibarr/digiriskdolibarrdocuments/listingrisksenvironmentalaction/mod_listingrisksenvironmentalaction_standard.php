...
/**
 * Class to manage listingrisksenvironmentalaction numbering rules standard
 */
class mod_listingrisksenvironmentalaction_standard extends ModeleNumRefSaturne
{
    /**
     * @var string Numbering module ref prefix
     */
    public string $prefix = 'RLE';

    /**
     * @var string Name
     */
    public string $name = 'Ersa';
}
