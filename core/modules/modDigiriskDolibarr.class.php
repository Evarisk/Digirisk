...
class modDigiriskdolibarr extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->description = "DigiriskdolibarrDescription";
		...
		*/
		...
		$this->cronjobs = array(
			...
			//      'label' => 'MyJob label',
			//      'jobtype' => 'method',
			//      'class' => '/digiriskdolibarr/class/digiriskresources.class.php',
			//      'objectname' => 'DigiriskResources',
		...
		$this->rights[$r][4] = 'digiriskresources'; // In php code, permission will be checked by test if ($user->rights->digiriskdolibarr->level1->level2)
		...
		$this->menu[$r++] = array(
			...
			'titre'=>'ModuleDigiriskdolibarrName',
			...
			'perms'=>'1', // Use 'perms'=>'$user->rights->digiriskdolibarr->digiriskresources->read' if you want your menu with a permission rules
			'target'=>'',
			'user'=>2, // 0=Menu for internal users, 1=external users, 2=both
		);
		/* END MODULEBUILDER TOPMENU */
		/* BEGIN MODULEBUILDER LEFTMENU DIGIRISKRESOURCES
		$this->menu[$r++]=array(
			...
			'titre'=>'DigiriskResources',
			'mainmenu'=>'digiriskdolibarr',
			'leftmenu'=>'digiriskresources',
			'url'=>'/digiriskdolibarr/digiriskdolibarrindex.php',
			'langs'=>'digiriskdolibarr@digiriskdolibarr',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>1000+$r,
			'enabled'=>'$conf->digiriskdolibarr->enabled',  // Define condition to show or hide menu entry. Use '$conf->digiriskdolibarr->enabled' if entry must be visible if module is enabled.
			'perms'=>'$user->rights->digiriskdolibarr->digiriskresources->read',			                // Use 'perms'=>'$user->rights->digiriskdolibarr->level1->level2' if you want your menu with a permission rules
			'target'=>'',
			'user'=>2,				                // 0=Menu for internal users, 1=external users, 2=both
		);
		$this->menu[$r++]=array(
			'fk_menu'=>'fk_mainmenu=digiriskdolibarr,fk_leftmenu=digiriskresources',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>'List DigiriskResources',
			'mainmenu'=>'digiriskdolibarr',
			'leftmenu'=>'digiriskdolibarr_digiriskresources_list',
			'url'=>'/digiriskdolibarr/digiriskresources_list.php',
			'langs'=>'digiriskdolibarr@digiriskdolibarr',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>1000+$r,
		...
		$this->menu[$r++]=array(
			'fk_menu'=>'fk_mainmenu=digiriskdolibarr,fk_leftmenu=digiriskresources',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>'New DigiriskResources',
			'mainmenu'=>'digiriskdolibarr',
			'leftmenu'=>'digiriskdolibarr_digiriskresources_new',
			'url'=>'/digiriskdolibarr/digiriskresources_card.php?action=create',
			'langs'=>'digiriskdolibarr@digiriskdolibarr',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>1000+$r,
			'enabled'=>'$conf->digiriskdolibarr->enabled',  // Define condition to show or hide menu entry. Use '$conf->digiriskdolibarr->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
			'perms'=>'$user->rights->digiriskdolibarr->digiriskresources->write',			                // Use 'perms'=>'$user->rights->digiriskdolibarr->level1->level2' if you want your menu with a permission rules
			'target'=>'',
			'user'=>2,				                // 0=Menu for internal users, 1=external users, 2=both
		);
		*/
        ...
        $this->menu[$r++]=array(
            ...
            'titre'=>'List DigiriskResources',
            'mainmenu'=>'digiriskdolibarr',
            'leftmenu'=>'digiriskdolibarr_digiriskresources',
            'url'=>'/digiriskdolibarr/digiriskresources_list.php',
            // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
            'langs'=>'digiriskdolibarr@digiriskdolibarr',
            'position'=>1100+$r,
            // Define condition to show or hide menu entry. Use '$conf->digiriskdolibarr->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
            'enabled'=>'$conf->digiriskdolibarr->enabled',
            // Use 'perms'=>'$user->rights->digiriskdolibarr->level1->level2' if you want your menu with a permission rules
            'perms'=>'1',
            'target'=>'',
        ...
        $this->menu[$r++]=array(
            // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
            'fk_menu'=>'fk_mainmenu=digiriskdolibarr,fk_leftmenu=digiriskdolibarr_digiriskresources',
            // This is a Left menu entry
            'type'=>'left',
            'titre'=>'New DigiriskResources',
            'mainmenu'=>'digiriskdolibarr',
		...
		/* END MODULEBUILDER LEFTMENU DIGIRISKRESOURCES */

		// Exports profiles provided by this module
		$r = 1;
		/* BEGIN MODULEBUILDER EXPORT DIGIRISKRESOURCES */
		/*
		$langs->load("digiriskdolibarr@digiriskdolibarr");
		$this->export_code[$r]=$this->rights_class.'_'.$r;
		$this->export_label[$r]='DigiriskResourcesLines';	// Translation key (used only if key ExportDataset_xxx_z not found)
		$this->export_icon[$r]='digiriskresources@digiriskdolibarr';
		// Define $this->export_fields_array, $this->export_TypeFields_array and $this->export_entities_array
		$keyforclass = 'DigiriskResources'; $keyforclassfile='/digiriskdolibarr/class/digiriskresources.class.php'; $keyforelement='digiriskresources@digiriskdolibarr';
		include DOL_DOCUMENT_ROOT.'/core/commonfieldsinexport.inc.php';
		//$this->export_fields_array[$r]['t.fieldtoadd']='FieldToAdd'; $this->export_TypeFields_array[$r]['t.fieldtoadd']='Text';
		//unset($this->export_fields_array[$r]['t.fieldtoremove']);
		//$keyforclass = 'DigiriskResourcesLine'; $keyforclassfile='/digiriskdolibarr/class/digiriskresources.class.php'; $keyforelement='digiriskresourcesline@digiriskdolibarr'; $keyforalias='tl';
		//include DOL_DOCUMENT_ROOT.'/core/commonfieldsinexport.inc.php';
		$keyforselect='digiriskresources'; $keyforaliasextra='extra'; $keyforelement='digiriskresources@digiriskdolibarr';
		include DOL_DOCUMENT_ROOT.'/core/extrafieldsinexport.inc.php';
		//$keyforselect='digiriskresourcesline'; $keyforaliasextra='extraline'; $keyforelement='digiriskresourcesline@digiriskdolibarr';
		//include DOL_DOCUMENT_ROOT.'/core/extrafieldsinexport.inc.php';
		//$this->export_dependencies_array[$r] = array('digiriskresourcesline'=>array('tl.rowid','tl.ref')); // To force to activate one or several fields if we select some fields that need same (like to select a unique key if we ask a field of a child to avoid the DISTINCT to discard them, or for computed field than need several other fields)
		//$this->export_special_array[$r] = array('t.field'=>'...');
		//$this->export_examplevalues_array[$r] = array('t.field'=>'Example');
		//$this->export_help_array[$r] = array('t.field'=>'FieldDescHelp');
		$this->export_sql_start[$r]='SELECT DISTINCT ';
		$this->export_sql_end[$r]  =' FROM '.MAIN_DB_PREFIX.'digiriskresources as t';
		//$this->export_sql_end[$r]  =' LEFT JOIN '.MAIN_DB_PREFIX.'digiriskresources_line as tl ON tl.fk_digiriskresources = t.rowid';
		$this->export_sql_end[$r] .=' WHERE 1 = 1';
		$this->export_sql_end[$r] .=' AND t.entity IN ('.getEntity('digiriskresources').')';
		$r++; */
		/* END MODULEBUILDER EXPORT DIGIRISKRESOURCES */

		// Imports profiles provided by this module
		$r = 1;
		/* BEGIN MODULEBUILDER IMPORT DIGIRISKRESOURCES */
		/*
		 $langs->load("digiriskdolibarr@digiriskdolibarr");
		 $this->export_code[$r]=$this->rights_class.'_'.$r;
		 $this->export_label[$r]='DigiriskResourcesLines';	// Translation key (used only if key ExportDataset_xxx_z not found)
		 ...
		 $this->export_sql_end[$r] .=' AND t.entity IN ('.getEntity('digiriskresources').')';
		 $r++; */
		/* END MODULEBUILDER IMPORT DIGIRISKRESOURCES */
	}
	...
	public function init($options = '')
	{
		...
		$myTmpObjects = array();
		$myTmpObjects['DigiriskResources']=array('includerefgeneration'=>0, 'includedocgeneration'=>0);

		foreach ($myTmpObjects as $myTmpObjectKey => $myTmpObjectArray) {
			if ($myTmpObjectKey == 'DigiriskResources') continue;
			if ($myTmpObjectArray['includerefgeneration']) {
				$src=DOL_DOCUMENT_ROOT.'/install/doctemplates/digiriskdolibarr/template_digiriskresourcess.odt';
				$dirodt=DOL_DATA_ROOT.'/doctemplates/digiriskdolibarr';
				$dest=$dirodt.'/template_digiriskresourcess.odt';
