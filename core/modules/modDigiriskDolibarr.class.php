...
class modDigiriskdolibarr extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->const = [
			...
			$i++ => ['DIGIRISKDOLIBARR_TICKET_CREATION_CUSTOM_REDIRECTION_URL', 'chaine', '', '', 0, 'current'],
			$i++ => ['DIGIRISKDOLIBARR_TICKET_CREATION_OPTION', 'chaine', 'original_redirection_link', '', 0, 'current'],
