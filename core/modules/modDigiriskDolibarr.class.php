...
class modDigiriskdolibarr extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->const = array(
			...
			$i++ => array('DIGIRISKDOLIBARR_MAIN_AGENDA_ACTIONAUTO_PREVENTIONPLANSIGNATURE_DELETEATTENDANT', 'integer', 1, '', 0, 'current'),
			...
			$i++ => array('DIGIRISKDOLIBARR_MAIN_AGENDA_ACTIONAUTO_FIREPERMITSIGNATURE_DELETEATTENDANT', 'integer', 1, '', 0, 'current'),
