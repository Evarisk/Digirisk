...
class modDigiriskdolibarr extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->const = array(
			...
			$i++ => array('DIGIRISKDOLIBARR_MAIN_AGENDA_ACTIONAUTO_PREVENTIONPLAN_ADDATTENDANT', 'integer', 1, '', 0, 'current'),
			...
			$i++ => array('DIGIRISKDOLIBARR_MAIN_AGENDA_ACTIONAUTO_FIREPERMIT_ADDATTENDANT', 'integer', 1, '', 0, 'current'),
...
//			$i++ => array('DIGIRISKDOLIBARR_ACCIDENTDOCUMENT_DEFAULT_MODEL', 'chaine', 'accidentdocument_odt', '', 0, 'current'),
			...
			// CONST SIGNATURE
			$i++ => array('DIGIRISKDOLIBARR_MAIN_AGENDA_ACTIONAUTO_SIGNATURE_GENERATE', 'integer', 1, '', 0, 'current'),
