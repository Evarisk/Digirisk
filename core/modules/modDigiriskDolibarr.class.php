...
class modDigiriskdolibarr extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->const = [
			...
			319 => array('DIGIRISKDOLIBARR_TICKET_PUBLIC_INTERFACE_USE_MULTIENTITY_CONFIG', 'integer', 0, '', 0, 'current'),

			//CONST MULTICOMPANY TICKET
			320 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_ENABLE_PUBLIC_INTERFACE', 'integer', 1, '', 0, 'current'),
			...
			328 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_DIGIRISKELEMENT_VISIBLE', 'integer', 1, '', 0, 'current'),
			329 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_DIGIRISKELEMENT_REQUIRED', 'integer', 1, '', 0, 'current'),
			330 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_DIGIRISKELEMENT_HIDE_REF', 'integer', 0, '', 0, 'current'),
			331 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_PHOTO_VISIBLE', 'integer', 1, '', 0, 'current'),
			332 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_EMAIL_VISIBLE', 'integer', 0, '', 0, 'current'),
			333 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_EMAIL_REQUIRED', 'integer', 0, '', 0, 'current'),
			334 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_FIRSTNAME_VISIBLE', 'integer', 1, '', 0, 'current'),
			335 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_FIRSTNAME_REQUIRED', 'integer', 1, '', 0, 'current'),
			336 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_LASTNAME_VISIBLE', 'integer', 1, '', 0, 'current'),
			337 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_LASTNAME_REQUIRED', 'integer', 1, '', 0, 'current'),
			338 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_PHONE_VISIBLE', 'integer', 1, '', 0, 'current'),
			339 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_PHONE_REQUIRED', 'integer', 0, '', 0, 'current'),
			340 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_LOCATION_VISIBLE', 'integer', 1, '', 0, 'current'),
			341 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_LOCATION_REQUIRED', 'integer', 0, '', 0, 'current'),
			342 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_DATE_VISIBLE', 'integer', 1, '', 0, 'current'),
			343 => array('DIGIRISKDOLIBARR_MULTICOMPANY_TICKET_DATE_REQUIRED', 'integer', 1, '', 0, 'current'),
...
//			$i++ => ['DIGIRISKDOLIBARR_ACCIDENTDOCUMENT_DEFAULT_MODEL', 'chaine', 'accidentdocument_odt', '', 0, 'current'],
		...
		$this->tabs[] = array('data' => 'multicompany:+ticket:' . $pictoDigirisk . $langs->trans('Ticket').':digiriskdolibarr@digiriskdolibarr:1:/custom/digiriskdolibarr/admin/ticket/multicompany_ticket.php');														// To add a new tab identified by code tabname1
