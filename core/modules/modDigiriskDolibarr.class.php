...
class modDigiriskdolibarr extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->hidden                  = false;
		$this->depends                 = array('modECM', 'modProjet', 'modSociete', 'modTicket', 'modCategorie', 'modFckeditor');
...
//		);
	...
	public function init($options = '')
	{
		...
		$extra_fields->addExtraField( 'fk_firepermit', $langs->trans("fk_firepermit"), 'sellist', 1030, '', 'projet_task', 0, 0, '', 'a:1:{s:7:"options";a:1:{s:56:"digiriskdolibarr_preventionplan:ref:rowid::entity = $ENTITY$";N;}}', '', '', 1);
