							...
							<div class="element-linked-medias element-linked-medias-<?php echo $lastEvaluation->id; ?> risk-<?php echo $risk->id ?>">
								...
								<table class="add-medias">
									<tr>
										...
										<td>
											<div title="<?php echo $langs->trans('AddPhotoFromMediaGallery') ?>" class="wpeo-button <?php echo ($onPhone ? 'button-square-40' : 'button-square-50'); ?> 'open-media-gallery add-media modal-open" value="<?php echo $lastEvaluation->id; ?>">
