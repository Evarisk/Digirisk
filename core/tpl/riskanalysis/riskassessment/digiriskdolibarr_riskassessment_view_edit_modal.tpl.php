			...
			<div class="modal-content" id="#modalContent<?php echo $lastEvaluation->id ?>">
				...
				<div class="risk-evaluation-container <?php echo $lastEvaluation->method; ?>">
					<div class="risk-evaluation-header" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
                        ...
                        <div class="risk-evaluation-header-right riskassessment-medias linked-medias riskassessment-photo-<?php echo $lastEvaluation->id; ?>">
                    ...
                    <div class="risk-evaluation-content-wrapper">
                        ...
                        <div class="risk-evaluation-comment">
                            ...
                            <?php print '<textarea class="evaluation-comment-textarea" name="evaluationComment' . $lastEvaluation->id . '" rows="' . ROWS_2 . '">' . $lastEvaluation->comment . '</textarea>' . "\n"; ?>
                        </div>
                    </div>
				</div>
			</div>
