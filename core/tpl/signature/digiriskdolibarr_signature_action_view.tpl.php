	<div class="wpeo-dropdown">
		...
		<?php if ($object->status == 2) : ?>
			<?php if (($element->role == 'PP_EXT_SOCIETY_INTERVENANTS' || $element->role == 'FP_EXT_SOCIETY_INTERVENANTS') && empty($element->signature) && $element->status != $element::STATUS_ABSENT) : ?>
...
<?php if ($object->status == 1) : ?>
	<?php if ($element->role == 'PP_EXT_SOCIETY_INTERVENANTS' || $element->role == 'FP_EXT_SOCIETY_INTERVENANTS') : ?>
		<li class="dropdown-item">
