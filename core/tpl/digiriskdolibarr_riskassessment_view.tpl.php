		...
		<div class="risk-evaluation-single-content risk-evaluation-single-content-<?php echo $risk->id ?>">
			<div class="risk-evaluation-single risk-evaluation-single-<?php echo $risk->id ?>">
				...
				<?php if ($permissiontoread) : ?>
					<div class="risk-evaluation-list wpeo-button button-square-40 button-primary wpeo-tooltip-event modal-open" aria-label="<?php echo $langs->trans('RiskAssessmentList') ?>" value="<?php echo $risk->id ?>">
				...
				<?php if ($permissiontoadd) : ?>
					...
					<div class="risk-evaluation-edit wpeo-button button-square-50 button-grey wpeo-tooltip-event modal-open" aria-label="<?php echo $langs->trans('EditRiskAssessment') ?>" value="<?php echo $lastEvaluation->id;?>">
				...
				<div class="risk-evaluation-container">
					...
					<div class="risk-evaluation-edit-modal" value="<?php echo $lastEvaluation->id ?>">
						<div class="wpeo-modal modal-risk" id="risk_evaluation_edit<?php echo $lastEvaluation->id ?>">
