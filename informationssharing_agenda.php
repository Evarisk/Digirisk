...
/**
 *  \file       informationssharing_agenda.php
 *  \ingroup    digiriskdolibarr
 *  \brief      Page of InformationsSharing events
 */
...
$hookmanager->initHooks(array('informationssharingagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("InformationsSharing"), -1, 'object_'.$object->picto);
