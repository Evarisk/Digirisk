 ...
 *		\brief      List page for firepermit
 */
...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'firepermitlist'; // To manage different context of search
...
$hookmanager->initHooks(array('firepermitlist')); // Note that conf->hooks_modules contains array
...
if (empty($reshook))
{
	...
	// Mass actions
	$objectclass = 'FirePermit';
	$objectlabel = 'FirePermit';
...
//$help_url="EN:Module_FirePermit|FR:Module_FirePermit_FR|ES:Módulo_FirePermit";
...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/digiriskdolibarr/firepermit_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendFirePermitRef";
$modelmail = "firepermit";
$objecttmp = new FirePermit($db);
