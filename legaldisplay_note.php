...
/**
 *  \file       legaldisplay_note.php
 *  \ingroup    digiriskdolibarr
 *  \brief      Car with notes on LegalDisplay
 */
...
$hookmanager->initHooks(array('legaldisplaynote', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($id > 0 || !empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("LegalDisplay"), -1, $object->picto);
