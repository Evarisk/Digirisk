...
/**
 *	Class to manage PDF template standard_risk
 */
class pdf_standard_risk extends ModelePDFRisk
{
    /**
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
	    ...
	    /*
	    if (!empty($conf->global->MAIN_GENERATE_RISK_WITH_PICTURE))
	    {
		...
		*/
	    ...
	    if ($conf->digiriskdolibarr->dir_output.'/risk')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->digiriskdolibarr->dir_output.'/risk';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->digiriskdolibarr->dir_output.'/risk/'.$objectref;
