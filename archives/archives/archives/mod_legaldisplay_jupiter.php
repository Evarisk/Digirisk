...
dol_include_once('/custom/digiriskdolibarr/core/modules/digiriskdolibarr/modules_digiriskdocuments.php');

/**
 * 	Class to manage legaldisplay numbering rules Standard
 */
class mod_legaldisplay_advanced extends ModeleNumRefDigiriskDocuments
{
	/**
	...
	public function info()
	{
		...
		return $langs->trans('DigiriskLegalDisplayStandardModel', $this->prefix);
	}
	...
	public function getNextValue($object, $version = 0)
	{
		...
		{
			dol_syslog("mod_legaldisplay_advanced::getNextValue", LOG_DEBUG);
			return -1;
		}
		...
		dol_syslog("mod_legaldisplay_advanced::getNextValue return ".$this->prefix.$num);
