...
$hookmanager->initHooks(array('risknote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Risk'), $help_url);
...
if ($id > 0 || !empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("Risk"), -1, $object->picto);
