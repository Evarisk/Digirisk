...
/**
 *  \file       risk_agenda.php
 *  \ingroup    digiriskdolibarr
 *  \brief      Page of Risk events
 */
...
$hookmanager->initHooks(array('riskagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("Risk"), -1, 'object_'.$object->picto);
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read)))
	{
		...
		//print load_fiche_titre($langs->trans("ActionsOnRisk"), '', '');
