...
/**
 *  \file       firepermit_note.php
 *  \ingroup    digiriskdolibarr
 *  \brief      Car with notes on FirePermit
 */
...
$hookmanager->initHooks(array('firepermitnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permissionnote = $user->rights->digiriskdolibarr->firepermit->write; // Used by the include of actions_setnotes.inc.php
...
llxHeader('', $langs->trans('FirePermit'), $help_url);
...
if ($id > 0 || !empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("FirePermit"), -1, $object->picto);
