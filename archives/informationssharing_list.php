...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/digiriskdolibarr/informationssharing_card.php', 1).'?action=create', '', $permissiontoadd);
