...
/**
 *  \file       digiriskelement_note.php
 *  \ingroup    digiriskdolibarr
 *  \brief      Car with notes on DigiriskElement
 */
...
$hookmanager->initHooks(array('digiriskelementnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permissionnote = $user->rights->digiriskdolibarr->digiriskelement->write; // Used by the include of actions_setnotes.inc.php
...
$help_url = '';
llxHeader('', $langs->trans('DigiriskElement'), $help_url);
...
if ($id > 0 || !empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("DigiriskElement"), -1, $object->picto);
