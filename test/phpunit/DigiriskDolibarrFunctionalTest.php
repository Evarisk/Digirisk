...
class DigiriskdolibarrFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/digiriskdolibarr/admin/about.php');
		$this->authenticate();
		return $this->assertContains('digiriskdolibarr/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('digiriskdolibarrwidget1', $this->source(), "Box enabled");
	}
