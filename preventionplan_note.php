...
/**
 *  \file       preventionplan_note.php
 *  \ingroup    digiriskdolibarr
 *  \brief      Car with notes on PreventionPlan
 */
...
$hookmanager->initHooks(array('preventionplannote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permissionnote = $user->rights->digiriskdolibarr->preventionplan->write; // Used by the include of actions_setnotes.inc.php
...
llxHeader('', $langs->trans('PreventionPlan'), $help_url);
...
if ($id > 0 || !empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("PreventionPlan"), -1, $object->picto);
