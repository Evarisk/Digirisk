 ...
 *		\brief      List page for preventionplan
 */
...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'preventionplanlist'; // To manage different context of search
...
$hookmanager->initHooks(array('preventionplanlist')); // Note that conf->hooks_modules contains array
...
//$help_url="EN:Module_PreventionPlan|FR:Module_PreventionPlan_FR|ES:Módulo_PreventionPlan";
...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/digiriskdolibarr/preventionplan_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendPreventionPlanRef";
$modelmail = "preventionplan";
$objecttmp = new PreventionPlan($db);
